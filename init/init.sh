...
-- User 4: Debezium CDC replication user
CREATE USER "${DEBEZIUM_SA_USER}" WITH REPLICATION LOGIN PASSWORD '${DEBEZIUM_SA_PASSWORD}';
GRANT CONNECT ON DATABASE ${PG_SPOTIFY_DB} TO "${DEBEZIUM_SA_USER}";
